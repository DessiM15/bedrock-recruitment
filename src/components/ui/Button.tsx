...
export function Button({
  ...
  const classes = cn(
    "inline-flex items-center justify-center gap-2 rounded-lg font-bold uppercase tracking-wide transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-tan focus:ring-offset-2",
